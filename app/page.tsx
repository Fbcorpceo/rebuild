...
import { servicesByCategory, categoryBlurbs } from "@/lib/services";

export const metadata: Metadata = {
  title: `${site.brand} — Home Services in ${site.primaryCity}`,
    ...
    <>
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h1 className="mt-4 max-w-3xl text-5xl font-black leading-tight tracking-tight text-slate-900">
          {site.brand} Rebuild — {site.primaryCity}'s crew for every part of your home.
        </h1>
          ...
          items.length === 0 ? null : (
            <div key={category} className="mb-10">
              <div className="mb-4 flex items-baseline justify-between gap-4">
                ...
                <p className="hidden max-w-xl text-sm text-slate-600 sm:block">{categoryBlurbs[category]}</p>
              </div>
