...
export const services: Service[] = [
  ...
  },
  {
    ...
    trustBadges: ["CSLB #1068191", "Bonded & Insured", "5.0★ on Google"],
  ...
  },
  {
    ...
    name: "Plumbing",
    category: "Trades",
    h1: "Rough-In & Addition Plumbing in {{city}}. Licensed Master Plumbers.",
    subheadline:
      "Plumbing rough-in for new builds, ADUs, and additions — plus line extensions and fixture add-ons. Fixed-price bids, clean installs, inspection-ready.",
    heroImage:
      "https://images.unsplash.com/photo-1585128792020-803d29415281?auto=format&fit=crop&w=1600&q=70",
    offer: "Free on-site walk-through + fixed-price bid",
    priceRange: "",
    ...
    qualifying: [
      ...
      {
        id: "scope",
        label: "What's the plumbing scope?",
        type: "radio",
        required: true,
        options: [
          { value: "rough-in", label: "Rough-in for new construction" },
          { value: "adu", label: "ADU or addition" },
          { value: "fixture", label: "Adding a fixture (sink / toilet / shower)" },
          { value: "extension", label: "Extending lines to a new area" },
    ...
    faqs: [
      { q: "Do you pull the permits?", a: "Yes. Plumbing permits, rough-in inspections, and final sign-off are included in the bid." },
      { q: "Are you licensed?", a: "CSLB Lic. #1068191. Bonded and insured." },
      { q: "Can you coordinate with our framer and GC?", a: "Yes. We routinely sub under other GCs and schedule around their framing and drywall dates." },
    ],
    trustBadges: ["CSLB #1068191", "Bonded & Insured", "Permits Pulled", "5.0★ on Google"],
    localKeywords: ["rough-in plumber {{city}}", "ADU plumbing", "addition plumbing near me", "new construction plumbing"],
  },
  {
    slug: "design-build",
    name: "Design-Build",
    ...
    qualifying: [
      ...
      {
        id: "scale",
        label: "Rough project scale",
        type: "select",
        required: true,
        options: [
          { value: "small", label: "Small upgrade / single room" },
          { value: "mid", label: "Mid-size remodel or addition" },
          { value: "large", label: "Major remodel / ADU" },
          { value: "flagship", label: "Whole-home or new build" },
